  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            _BuildImage(article: article ?? const ArticleEntity()),
            _BuildTitleAndDescription(
                article: article ?? const ArticleEntity()),
            _BuildRemovableArea(
              isRemoveable: isRemovable ?? false,
...
class _BuildTitleAndDescription extends StatelessWidget {
  ...
  const _BuildTitleAndDescription({required this.article});
